...
inline void TextOutInt(HDC hdc, int x, int y, string whatIsIt, int intInput)
{
	whatIsIt += " : ";
	whatIsIt += to_string(intInput);
	TextOut(hdc, x, y, whatIsIt.c_str(), whatIsIt.size());
}

inline void TextOutfloat(HDC hdc, int x, int y, string whatIsIt, float floatInput)
{
	whatIsIt += " : ";
	whatIsIt += to_string(floatInput);
	TextOut(hdc, x, y, whatIsIt.c_str(), whatIsIt.size());
}
